...
/**
 * This class provides a few useful static methods to build IR patterns.
 * 
 * @author kdvolder
 */
...
public class IRPat {
  ...
  // Stm patterns:
  public static Pat<IRStm> JUMP(Pat<IRExp> exp) {
    return new JUMPPat(exp);
  }
  ...
  public static Pat<IRStm> EXP(Pat<IRExp> exp) {
    return new EXPPat(exp);
  }
  ...
  public static Pat<IRStm> LABEL(Pat<Label> l) {
    return new LABELPat(l);
  }
  ...
  public static Pat<IRExp> PLUS(Pat<IRExp> l, Pat<IRExp> r) {
    return or(BINOP(Op.PLUS, l, r), BINOP(Op.PLUS, r, l));
  }

  public static Pat<IRExp> PLUS(Pat<IRExp> x, Pat<IRExp> y, Pat<IRExp> z) {
    return or(PLUS(x, PLUS(y, z)), PLUS(PLUS(x, y), z));
  }

  public static Pat<IRExp> MUL(Pat<IRExp> l, Pat<IRExp> r) {
    return or(BINOP(Op.MUL, l, r), BINOP(Op.MUL, r, l));
  }
  
  public static Pat<IRExp> AND(Pat<IRExp> l, Pat<IRExp> r) {
    return or(BINOP(Op.AND, l, r), BINOP(Op.AND, r, l));
  }
  ...
  public static Pat<IRExp> MEM(Pat<IRExp> exp) {
    return new MEMPat(exp);
  }

  public static Pat<IRExp> TEMP(Pat<Temp> t) {
    return new TEMPPat(t);
  }

  public static Pat<IRExp> NAME(Pat<Label> l) {
    return new NAMEPat(l);
  }

  public static Pat<IRExp> CONST(Pat<Integer> v) {
    return new CONSTPat(v);
  }

  public static Pat<IRExp> CONST(int i) {
    return CONST(new IntPat(i));
  }
